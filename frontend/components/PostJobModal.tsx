...
const PostJobModal: React.FC<PostJobModalProps> = ({ isOpen, onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // We call onSuccess to refresh dashboards, but we don't imply it's live immediately
      onSuccess();
      
      alert("Job submitted successfully! It will be visible after admin approval to prevent fraud.");
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
          ...
          >
            ...
            <div className="bg-yellow-50 px-6 py-3 border-b border-yellow-100 flex gap-3 items-start">
               ...
               <p className="text-xs text-yellow-800">
                  To ensure quality and safety, all jobs are reviewed by an admin before going live.
               </p>
            </div>
